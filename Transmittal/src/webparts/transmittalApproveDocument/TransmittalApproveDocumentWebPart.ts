...
export interface ITransmittalApproveDocumentWebPartProps {
  description: string;
}

export default class TransmittalApproveDocumentWebPart extends BaseClientSideWebPart<ITransmittalApproveDocumentWebPartProps> {
